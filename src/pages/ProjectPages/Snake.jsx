...
const Snake = () => {
  ...
  return (
    <ProjectPage
      ...
      siteLink="https://sdg877.github.io/Unit1_Project_Snake/"
      githubLinks={[{ label: "GitHub Link", url: "https://github.com/sdg877/Unit1_Project_Snake" }]}
      nextProjectPath="/projects/AIChatBot"
      nextProjectLabel="Next Project: AI Chatbot"
    />
  );
};
