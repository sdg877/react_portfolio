...
const projects = [
  {
    ...
    image: "AIChatBot.png",
    description: [
      "AI Chatbot is a conversational AI assistant built with React and OpenAI API integration.",
      "It supports natural language understanding and generates human-like responses.",
      "This project deepened my knowledge of APIs, React state management, and asynchronous operations.",
      "Future plans include adding voice input and improved context retention."
    ],
    siteUrl: "https://your-aichatbot-site.example.com",
    githubFrontendUrl: "https://github.com/sdg877/AIChatBotFrontend",
    githubBackendUrl: "https://github.com/sdg877/AIChatBotBackend",
  },
  {
    id: "GourmetGallery",
    title: "Gourmet Gallery",
    image: "GourmetGallery.png",
    description: [
      "Gourmet Gallery is a recipe sharing platform built with React and Firebase.",
      "Users can browse, add, and rate recipes with rich media support.",
      "Implemented real-time database syncing and user authentication.",
      "This project enhanced my skills in Firebase and React hooks."
    ],
  ...
  },
  {
    ...
    image: "HTreharneJones.png",
    description: [
      "Website built for H Treharne Jones estate agents using Next.js and Tailwind CSS.",
      "Includes property listings, contact forms, and client testimonials.",
      "Focus on SEO optimisation and responsive design.",
      "This project improved my Next.js routing and styling expertise."
    ],
    siteUrl: "https://htreharnejones.example.com",
    githubFrontendUrl: "https://github.com/sdg877/HTreharneJones",
    githubBackendUrl: "",
  },
  {
    id: "InTech",
    title: "inTech Jobs",
    image: "InTechJobs.png",
    description: [
