...
const SSS = () => {
  ...
  return (
    <ProjectPage
      ...
      image={SSSImage}
      altText="Sustainable Swap Shop"
      descriptionParagraphs={description}
      siteLink="http://sustainableswapfe-production.up.railway.app"
      githubLinks={[
        { label: "Frontend GitHub Link", url: "https://github.com/sdg877/sustainableswapfe" },
        { label: "Backend GitHub Link", url: "https://github.com/sdg877/sustainableswapbackend" },
      ]}
      nextProjectPath="/projects/inTechJobs"
      nextProjectLabel="Next Project: inTech Jobs"
    />
  );
};
