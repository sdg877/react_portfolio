    ...
    >
      ...
      <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 0.5 }}>
        ...
        <motion.p className="details" initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 0.6 }}>
          ...
          with customers, and manage sales and commissions. The site includes
          a secure admin area for content management, along with galleries, a
        ...
        <motion.p className="details" initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 0.7 }}>
          The client had a vision for a "clean" look with specific design preferences,
          including colours and a banner image. They also needed the ability to update
          artwork and news independently. I handled both the design and development
          while ensuring seamless user experience across devices.
        </motion.p>
        <br />
        <motion.p className="details" initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 0.8 }}>
          A key challenge was configuring the S3 bucket for image uploads, which I resolved
          by adjusting bucket settings. I also tackled issues with mobile file uploads
          by modifying nginx settings and fixed special character handling with
          backend encryption and frontend decryption.
        </motion.p>
        <br />
        <motion.p className="details" initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 0.9 }}>
          This project strengthened my ability to communicate technical concepts to
          non-technical clients and enhanced my project management skills. The website
          has been thoroughly tested, with no known bugs, and allows the client to manage
